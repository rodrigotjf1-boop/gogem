...
describe('RegemImportService.importar — reflexo de pausa (Fase 4)', () => {
  ...
  it('canal gogem / inativo / esgotado → disponivel=false; ifood não afeta', async () => {
    ...
    client.fetchCatalogo.mockResolvedValue({
      ...
      produtos: [
        { id: 'a', codigo: 'A', nome: 'Pausado canal', precoVenda: '10.00', categoriaId: 'rc', disponivelCardapio: true, ativo: true, canaisPausados: ['gogem'], grupos: [] },
        { id: 'b', codigo: 'B', nome: 'Inativo', precoVenda: '10.00', categoriaId: 'rc', disponivelCardapio: true, ativo: false, grupos: [] },
        { id: 'c', codigo: 'C', nome: 'Esgotado', precoVenda: '10.00', categoriaId: 'rc', disponivelCardapio: true, ativo: true, pausadoEstoque: true, grupos: [] },
        { id: 'd', codigo: 'D', nome: 'Ok', precoVenda: '10.00', categoriaId: 'rc', disponivelCardapio: true, ativo: true, canaisPausados: ['ifood'], grupos: [] },
      ],
    });
