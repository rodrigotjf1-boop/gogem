...
Código do kiosk gerado sem SDK Flutter no ambiente é **pré-validado só por análise estática**; o gate executável é `apps/kiosk/PRE-VOO.md`, rodado onde há SDK (máquina local / Claude Code / CI):
```bash
